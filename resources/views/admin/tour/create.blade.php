...
<div class="container-fluid">
	...
	{{Form::open(['url' => route('tour.create')])}}
	<div class="row">
		<div class="col-9">
			<nav>
			...
			<div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
				...
				<div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
					...
					<div class="form-group">
						...
						{{Form::textarea('brief',null,['class'=>'form-control input-border','rows' => '5', 'cols'=>'30'])}}
					</div>
					<div class="form-group">
			...
			<div class="form-row mb-1">
				...
				<label class="text-dark" >Địa Điểm</label>
					{{Form::select('destination',['1' => 'Châu Âu'],null,['class' => 'form-control input-border'])}}
				</div>
				<div class="col">
					<label class="text-dark">Giá (người lớn)</label>
					{{Form::number('price',0,['class' => 'form-control input-border','min' => '0'])}}
				</div>
				<div class="col">
					<label class="text-dark">Giá (trẻ em >10t)</label>
					{{Form::number('price_child',0,['class' => 'form-control input-border','min' => '0'])}}
				</div>
			</div>
