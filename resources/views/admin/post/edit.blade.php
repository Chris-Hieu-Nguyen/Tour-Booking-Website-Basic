...
<div class="container-fluid">
	...
	<div class="row">
		...
		<div class="col-3 mt-2">
			...
			<div class="form-group">
				<button class="btn bg-blue form-control text-white" style="border-radius:unset;"><i class="fab fa-telegram-plane"></i> &nbsp Sửa Viết</button>
			</div>
			<div class="form-group">
				<label for="photo" class="">{{__('label.avatar')}}</label>
				{!! Form::hidden('photo', '', ['id'=>'photo']) !!}
				<a href="javascript:openCustomRoxy()"><img src='{{$post->photo ? $post->photo : "/img/no-photo.png"}}' id="customRoxyImage" style="max-width:250px;"></a>
