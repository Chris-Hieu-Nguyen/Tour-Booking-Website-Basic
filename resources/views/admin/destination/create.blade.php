...
<div class="container-fluid">
	...
	{{Form::open(['url' => route('destination.store')])}}
	<div class="row">
		<div class="col-9">
			<nav>
		...
		<div class="col-3">
			<div class="form-group">
				<button class="btn bg-blue form-control text-white" style="border-radius:unset;"><i class="fab fa-telegram-plane"></i> &nbsp Thêm Điểm Đến</button>
            </div>
